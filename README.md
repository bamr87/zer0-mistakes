...
lastmod: 2026-04-02T04:36:41.000Z
draft: false
permalink: /
slug: zer0
keywords:
...
| Metric | Value |
|--------|-------|
| **Current Version** | 0.22.2 ([RubyGems](https://rubygems.org/gems/jekyll-theme-zer0), [CHANGELOG](/CHANGELOG)) |
...
**v0.22.2** • [Changelog](CHANGELOG.md) • [License](LICENSE) • [Contributing](CONTRIBUTING.md)
