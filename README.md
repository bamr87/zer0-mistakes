...
lastmod: 2026-05-24T21:20:14.000Z
draft: false
permalink: /
slug: zer0
keywords:
...
| Metric | Value |
|--------|-------|
| **Current Version** | 1.7.1 ([RubyGems](https://rubygems.org/gems/jekyll-theme-zer0), [CHANGELOG](/CHANGELOG)) |
...
**v1.7.1** • [Changelog](CHANGELOG.md) • [License](LICENSE) • [Contributing](CONTRIBUTING.md) • [AI Agent Guide](AGENTS.md)
