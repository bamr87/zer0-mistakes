...
lastmod: 2026-04-02T04:45:31.000Z
draft: false
permalink: /
slug: zer0
keywords:
...
| Metric | Value |
|--------|-------|
| **Current Version** | 0.22.3 ([RubyGems](https://rubygems.org/gems/jekyll-theme-zer0), [CHANGELOG](/CHANGELOG)) |
...
**v0.22.3** • [Changelog](CHANGELOG.md) • [License](LICENSE) • [Contributing](CONTRIBUTING.md)
