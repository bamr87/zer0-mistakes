...
lastmod: 2026-05-24T00:42:19.000Z
draft: false
permalink: /
slug: zer0
keywords:
...
| Metric | Value |
|--------|-------|
| **Current Version** | 1.7.0 ([RubyGems](https://rubygems.org/gems/jekyll-theme-zer0), [CHANGELOG](/CHANGELOG)) |
...
**v1.7.0** • [Changelog](CHANGELOG.md) • [License](LICENSE) • [Contributing](CONTRIBUTING.md) • [AI Agent Guide](AGENTS.md)
