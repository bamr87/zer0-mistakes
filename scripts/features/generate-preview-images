...
EXAMPLES:
    ...
    ./scripts/generate-preview-images.sh --enhance -f pages/_posts/my-post.md

    # Enhance with a custom prompt
    ./scripts/generate-preview-images.sh --enhance-prompt "Fix the text to read 'CI/CD Pipeline' and sharpen the icons" -f my-post.md

    # Enhance with high fidelity and JPEG output
    ./scripts/generate-preview-images.sh --enhance --enhance-fidelity high --enhance-format jpeg -f my-post.md

    # Enhance all images in a collection
    ./scripts/generate-preview-images.sh --enhance --collection posts
...
extract_front_matter() {
    ...
    # Extract content between first pair of --- markers only
...
get_yaml_value() {
    ...
    if [[ "$YAML_PARSER" == "yq" ]]; then
        ...
        # Python fallback - use stdin to avoid quote-escaping issues
...
# =============================================================================
# Enhancement Functions (improve existing preview images)
# =============================================================================

# Build the enhancement prompt from title, description, and optional custom prompt
