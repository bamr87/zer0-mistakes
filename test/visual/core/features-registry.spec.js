// =============================================================================
// features-registry.spec.js — Core meta-baseline for the /features/ registry
// =============================================================================
// The /features/ page renders the entire feature registry (_data/features.yml)
// as a reference table plus per-feature cards. Unlike a numbered product
// feature, this spec has no feature registry `tests:` link — it's a
// core meta-baseline guarding the registry page itself.
//
...
// These tests pin that the links render with correct GitHub hrefs, and that
// the table/cards render without swallowing rows, so a regression (renderer
// break, missing data, wrong base URL, broken markup) fails CI.
// =============================================================================
