/**
 * Navbar responsiveness regression suite.
 *
 ...
 * look "cut off" on the right at certain widths. These tests assert, across a
 * width matrix and several navbar configurations, that:
 *
...
const { NAV_WIDTHS, measureNavbarLayout, waitForJekyll, gotoOrSkip } = require('./fixtures');
