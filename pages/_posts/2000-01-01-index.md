...
<!-- Feature cards inlined to avoid Liquid nesting depth limit in news layout.
     For other layouts, use: {% raw %}{% include components/feature-card.html feature=f %}{% endraw %} -->
...
<!-- Component showcase inlined due to news layout nesting depth.
     For other layouts, use: {% raw %}{% include components/component-showcase.html %}{% endraw %} -->
