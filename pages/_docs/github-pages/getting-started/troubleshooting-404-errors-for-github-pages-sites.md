...
description: "This guide will help you troubleshoot common reasons you may be seeing a 404 error."
layout: default
categories:
    - docs
    - github-pages
...
tags:
    ...
    - documentation
    - reference
permalink: /docs/github-pages/getting-started/troubleshooting-404-errors-for-github-pages-sites/
difficulty: beginner
estimated_time: 10 minutes
sidebar:
    nav: docs
source_url: "https://github.com/github/docs/blob/main/content/pages/getting-started-with-github-pages/troubleshooting-404-errors-for-github-pages-sites.md"
...
* [GitHub's Status page](#githubs-status-page)* [DNS setup](#dns-setup)* [Browser cache](#browser-cache)
* [`index.html` file](#indexhtml-file)
* [Directory contents](#directory-contents)* [Custom domain](#custom-domain)* [Repository](#repository)
...
Make sure GitHub's DNS records are set up correctly with your DNS provider. For more information, see [Custom Domains: managing-a-custom-domain-for-your-github-pages-site](/docs/github-pages/custom-domains/managing-a-custom-domain-for-your-github-pages-site/).
### Browser cache
...
* Make sure you have an `index.html` file in the repository for your site on GitHub. For more information, see [Getting Started: creating-a-github-pages-site#creating-your-site](/docs/github-pages/getting-started/creating-a-github-pages-site#creating-your-site/).
...
If you're using a custom domain, make sure it's set up correctly. For more information, see [Custom Domains: about-custom-domains-and-github-pages](/docs/github-pages/custom-domains/about-custom-domains-and-github-pages/).

* The `CNAME` record should always point to `<USER>.github.io` or `<ORGANIZATION>.github.io`, excluding the repository name. <!-- See official GitHub docs for full instructions -->
...
> **Source**: This documentation is adapted from the [official GitHub Pages documentation](https://github.com/github/docs/blob/main/content/pages/getting-started-with-github-pages/troubleshooting-404-errors-for-github-pages-sites.md), licensed under [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/).
