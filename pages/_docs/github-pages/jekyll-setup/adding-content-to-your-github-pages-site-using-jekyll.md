...
description: "You can add a new page or post to your Jekyll site on GitHub Pages."
layout: default
categories:
    - docs
    - github-pages
...
tags:
    ...
    - documentation
    - reference
permalink: /docs/github-pages/jekyll-setup/adding-content-to-your-github-pages-site-using-jekyll/
difficulty: beginner
estimated_time: 10 minutes
sidebar:
    nav: docs
source_url: "https://github.com/github/docs/blob/main/content/pages/setting-up-a-github-pages-site-with-jekyll/adding-content-to-your-github-pages-site-using-jekyll.md"
...
Before you can add content to a Jekyll site on GitHub Pages, you must create a Jekyll site. For more information, see [Jekyll Setup: creating-a-github-pages-site-with-jekyll](/docs/github-pages/jekyll-setup/creating-a-github-pages-site-with-jekyll/).
...
Your theme includes default layouts and stylesheets that will automatically be applied to new pages and posts on your site, but you can override any of these defaults. For more information, see [Jekyll Setup: about-github-pages-and-jekyll#themes](/docs/github-pages/jekyll-setup/about-github-pages-and-jekyll#themes/).
