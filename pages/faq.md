...
faq_items:
  ...
  - question: "How do I install zer0-mistakes?"
    answer: "The fastest method is the one-line Docker install: mkdir my-site && cd my-site && curl -fsSL https://raw.githubusercontent.com/bamr87/zer0-mistakes/main/install.sh | bash. You can also install via RubyGems (gem install jekyll-theme-zer0) or use it as a GitHub Pages remote theme by adding remote_theme: bamr87/zer0-mistakes to your _config.yml."
  ...
  - question: "How do I add custom CSS or JavaScript?"
    answer: "Place custom CSS in assets/css/custom.css, which is loaded after the main theme styles. For JavaScript, add files to assets/js/ and include them via the _includes/components/js-cdn.html file. You can also override any Sass variable by creating files in the _sass/ directory."
  ...
  - question: "How do I contribute to zer0-mistakes?"
    answer: "Fork the repository on GitHub, create a feature branch, make your changes, run the test suite with ./test/test_runner.sh, and open a pull request. See CONTRIBUTING.md for detailed guidelines including code style, testing requirements, and the review process."
