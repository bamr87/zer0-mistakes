...
(function () {
  ...
  var COLLECTION_NAV = {
    ...
    cookbook: { title: 'Cookbook', url: '/cookbook/', icon: 'bi-egg-fried' }
  };
  ...
  function genCompose(c) {
    ...
    L.push('             bundle exec jekyll serve --watch --livereload --force_polling');
  ...
  function genIndex(c) {
    ...
    L.push('# ' + c.title);
    L.push('');
    if (c.f.tagline) { L.push('_' + c.f.tagline + '_'); L.push(''); }
    L.push(c.f.description || 'Welcome. This home page is `index.md` — edit it to say hello your way.');
    L.push('');
